...
enum Theme: Int {
    ...
    var mainColor: UIColor {
        switch self {
        case .theme1:
            return UIColor().colorFromHexString("#ECC554")
        case .theme2:
    ...
    var backgroundColor: UIColor {
        switch self {
        case .theme1:
            return UIColor().colorFromHexString("1F2124")
        case .theme2:
            return UIColor().colorFromHexString("000000")
        }
    }
    
    var grapeFruit: UIColor {
        switch self {
        case .theme1:
            return UIColor().colorFromHexString("#D4424F")
        case .theme2:
    ...
    var lightGray: UIColor {
        switch self {
        case .theme1:
            return UIColor().colorFromHexString("#404040")
        case .theme2:
    ...
    var darkGray: UIColor {
        switch self {
        case .theme1:
            return UIColor().colorFromHexString("#252729")
        case .theme2:
            return UIColor().colorFromHexString("#7C7C7C")
        }
    }
    ...
    var mint: UIColor {
        switch self {
        case .theme1:
            return UIColor().colorFromHexString("#3ED19E")
        case .theme2:
            return UIColor().colorFromHexString("#3ED19E")
        }
    }
